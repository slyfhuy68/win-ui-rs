...
impl MessageReceiver for Mycb {
    fn create(
        ...
        let mut link_button_1 = LinkButton::new(window, "链接按钮01", Some(((400, 0), 150, 50)), LINK_BUTTON_01, Default::default(), style.clone(), Default::default(), true, false)?;
        ...
        self.controls = Some(MyControls{
            button1: Button::new(window, "按钮01", Some(((0, 0), 150, 50)), BUTTON_01, Default::default(), style.clone(), Default::default(), true, false)?, 
            link_button_1, 
            split_button:SplitButton::new(window, "分割按钮01", Some(((200, 0), 150, 50)), SPLIT_BUTTON_01, Default::default(), style.clone(), Default::default(), true, false)?, 
            a2: RadioButton::new(&mut g_b, "单选按钮a02", Some(((150, 20), 100, 20)), RADIO_BUTTON_01_02, Default::default(), style.clone(), Default::default(), true, false)?, 
            b1: RadioButton::new(&mut g_b, "单选按钮b01", Some(((20, 70), 100, 20)), RADIO_BUTTON_02_01, Default::default(), style_group.clone(), Default::default(), true, false)?, 
            b2: RadioButton::new(&mut g_b, "单选按钮b02", Some(((150, 70), 100, 20)), RADIO_BUTTON_02_02, Default::default(), style.clone(), Default::default(), true, false)?, 
            boxed1: CheckBox::new(window, "选择框01", Some(((900, 0), 150, 50)), CHECK_BOX_01, Default::default(), style.clone(), Default::default(), true, false)?, 
            boxed2: CheckBox::new(window, "选择框02", Some(((900, 50), 150, 50)), CHECK_BOX_02, CheckBoxDrawType(ButtonAutoDrawType::TextOnly(false), {let mut state:CheckBoxStyle = Default::default();state.three_state=true;state}), style.clone(), Default::default(), true, false)?, 
            a1: RadioButton::new(&mut g_b, "单选按钮a01", Some(((20, 20), 100, 20)), RADIO_BUTTON_01_01, Default::default(), style_group.clone(), Default::default(), true, false)?, 
            g_b: GroupBox::from_window(g_b), 
            text_view: TextView::new(window, "文本11111111112", Some(((15, 75), 130, 50)), TEXT_VIEW_01, Default::default(), Default::default(), Default::default(), true, true)?, 
        });
...
fn main() -> Result<()> {
    ...
    //println!("{}", class);
    let mut window =
        class.create_window("中文😝öé English", Default::default(),None, Box::new(Mycb {num:0, controls:None}))?;
    window.Fshow(1)?;
    println!("ok");
